    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                ...
                <div class="sidebar-brand-text mx-3">sencompte</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseAdmin" class="collapse" aria-labelledby="headingPages"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="login.html">Liste des admins</a>
                        <a class="collapse-item" href="register.html">Nouveau admin</a>
                    </div>
                </div>
            </li>
                ...
                <ul class="navbar-nav ml-auto">
                                        ...
                                        <a class="dropdown-item d-flex align-items-center" href="#">
                                            ...
                                            <div>
                                                <div class="small text-gray-500">
                                                    {{ date('Y-m-d', strtotime($notification->date)) }}</div>
                                                <span class="font-weight-bold">{{ $notification->message }}</span>
                                            </div>
                                        </a>
                                    @endforeach
                                @else
                                    <h6 class="alert alert-default m-3">Pas de notifications</h6>
                                @endif
                            @endisset
                            <a class="dropdown-item text-center small text-gray-500" href="#">Voir tous les
                                notifications</a>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            @isset($messages)
                                @if (count($messages) != 0)
                                    ...
                                    @endforeach
                                @else
                                    <h6 class="alert alert-default m-3">Pas de messages</h6>
                                @endif
                            @endisset
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" data-toggle="modal" role="button" data-target="#logoutModal">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Votre session sera destroy.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Annuler</button>
                    <a class="btn btn-primary" onclick="event.preventDefault();
                    document.getElementById('logout-form').submit();">{{ __('Déconnection') }}</a>
